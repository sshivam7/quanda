...
urlpatterns = [
    ...
    # Change quanda votes 
    path('question/<int:pk>/<int:change>', views.question_vote_change, name='question-vote-change'),
    path('answer/<int:qid>/<int:pk>/<int:change>', views.answer_vote_change, name='answer-vote-change'),
    ...
    path('questions/<int:pk>/mark-resolved', views.mark_resolved, name='mark-resolved'),
    # Create, edit, and delete answers
    path('questions/<int:qid>/answer/', views.AnswerCreate.as_view(), name='new-answer'),
    path('questions/<int:pk>/answer-delete/', views.AnswerDelete.as_view(), name='answer-delete'),
    path('questions/<int:pk>/answer-update/', views.AnswerUpdate.as_view(), name='answer-update'),
    # create a new user 
